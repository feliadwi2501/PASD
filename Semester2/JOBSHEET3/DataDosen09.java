...
public class DataDosen09 {
    // Mengubah parameter menjadi Dosen09[]
    ...
    void rataRataUsiaDosenperJenisKelamin(Dosen09[] arrayOfDosen) {
        int totalUsiaLaki = 0;
        ...
        // Menambahkan pengecekan pembagian dengan nol agar tidak error NaN
        double rataRataLaki = (jumlahLaki > 0) ? (double) totalUsiaLaki / jumlahLaki : 0;
        double rataRataPerempuan = (jumlahPerempuan > 0) ? (double) totalUsiaPerempuan / jumlahPerempuan : 0;
    ...
    void DosenTertua(Dosen09[] arrayOfDosen) {
    ...
    void DosenTermuda(Dosen09[] arrayOfDosen) {
